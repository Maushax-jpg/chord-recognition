...
if __name__ == "__main__":
    parser = ArgumentParser(prog='create a circular pitch space model',
                             description='creates labeled chromadata from existing chromagrams')
    ...
    chromadata = {}
    filepath = os.path.join(script_directory, "models","chromadata",f"chromadata_{args.chroma}.hdf5")
    ...
    outputpath = os.path.join(script_directory, "models","cpss",f"cpss_{args.alphabet}_{args.chroma}.npy")
